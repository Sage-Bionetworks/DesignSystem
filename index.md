...
<div class="u-margin-bottom-double"><a href="{{ "/getting-started.html" | relative_url }}" class="c-btn">Get Started</a></div>
...
## Contributing info
If it's desirable to have people from across the organization contribute to the design system, linking to the <a href="{{ "/contributing.html" | relative_url }}">contributing page</a> from the homepage could be a good idea.
